...
int wl_display_add_socket_fd(struct wl_display *display, const char *name, int sock_fd);
const char *wl_display_add_socket_auto(struct wl_display *display);
const char *wl_display_add_socket_fd_auto(struct wl_display *display, int sock_fd);
