...
static unsigned int buffersize_for_closure(struct wl_closure *closure)  {
	const struct wl_message *message = closure->message;
...
wl_closure_send(struct wl_closure *closure, struct wl_connection *connection)
{
	...
	uint32_t buffer_size = buffersize_for_closure(closure);
	...
	int result = wl_connection_write(connection, buffer, size);
	free(buffer);
...
wl_closure_queue(struct wl_closure *closure, struct wl_connection *connection)
{
	...
	int result = wl_connection_queue(connection, buffer, size);
	free(buffer);
